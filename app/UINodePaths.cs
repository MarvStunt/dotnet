...
public static class UINodePaths
{
    ...
    public const string GameStartEndHBox = MasterSection + "/GameStartEndHBox";
    ...
    public const string StartGameButton = GameStartEndHBox + "/StartGameButton";
    public const string EndGameButton = GameStartEndHBox + "/EndGameButton";
    #endregion
